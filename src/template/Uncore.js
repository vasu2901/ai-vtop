    ...
    return (
        <div>
            ...
            <div className="container my-3" style={{ marginTop: "75px" }}>
                <center>
                    <table style={{ border: '5px solid ', cellspacing: "0" }} >
                        <thead>
                            <tr style={{ rowspan: "2", border: '5px solid' }}>
                                <th>
                                    Course Structure
                                ...
                                <th style={{ width: "100", backgroundColor: "0#2980b9" }}>
                                    Total
                            ...
                            <tr>
                                ...
                                <td style={{ width: "100", backgroundColor: "0#2980b9" }}>
                                    160
                    ...
                    <div className="container my-3" style={{ paddingTop: "5px", paddingBottom: "5px", paddingLeft: "10px", paddingRight: "10px", marginTop: "75px" }}>
                        <table style={{ border: '5px solid', cellspacing: "0" }}>
                            <thead>
                                <tr style={{ align: "center" }}>
                                    <th style={{ colspan: '3px solid', backgroundColor: "#2980b9" }}>
                            ...
                            <thead>
                                <tr style={{ align: "center", border: "5px solid" }}>
                                    <th style={{ colspan: "3" , border: "5px solid"}} >
